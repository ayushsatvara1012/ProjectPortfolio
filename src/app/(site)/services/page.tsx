...
export default function ServicesPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 pt-24 pb-20 transition-colors duration-500">
      ...
      {/* Catalog Grid */}
      <ScrollReveal className="px-6 md:px-12 lg:px-0 max-w-7xl mx-auto">
          ...
          {services.map((service) => (
            <div key={service.id} className="bg-white dark:bg-slate-950 rounded-none p-6 md:p-8 flex flex-col transition-colors duration-500">
              ...
              <div className="mt-auto pt-8">
                <Link href="/contact" className="rounded-none bg-slate-900 dark:bg-indigo-600 text-md font-display uppercase tracking-widest font-bold text-white px-6 py-4 hover:bg-slate-800 dark:hover:bg-indigo-500 w-full text-center block transition-colors">
                  Configure Project
                </Link>
              </div>
            </div>
      ...
      {/* Bottom CTA */}
      <ScrollReveal className="px-6 md:px-12 lg:px-0 max-w-7xl mx-auto mt-16 md:mt-24">
