                        ...
                        <div className="mt-3 flex flex-col gap-2">
                            <div className="px-3 py-2 bg-emerald-50 dark:bg-emerald-900/20 border-l-4 border-emerald-500 flex items-center gap-2 w-fit">
                                ...
                                <p className="text-[10px] font-google font-bold text-emerald-700 dark:text-emerald-300 uppercase tracking-widest">
                                    Basic plan is $9/mo — use coupon <span className="bg-emerald-100 dark:bg-emerald-900/40 px-1.5 py-0.5 rounded font-mono tracking-normal">{BASIC_COUPON}</span> at checkout for 100% off
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        {plans.map((plan, i) => (
                            ...
                            >
                                ...
                                {(plan.highlight || (plan as any).badge) && (
                                    <div className={`absolute top-0 right-0 px-3 py-1 text-white text-[9px] uppercase tracking-widest font-bold font-sans ${plan.highlight ? 'bg-gradient-to-r from-blue-600 to-green-600' : 'bg-gradient-to-r from-emerald-600 to-teal-600'}`}>
                                        {(plan as any).badge ?? 'Recommended'}
                                    </div>
                                )}

                                {/* Icon */}
                                <div className={`w-10 h-10 border flex items-center justify-center mb-5 shrink-0 transition-colors ${plan.highlight
                                    ? 'bg-gradient-to-br from-blue-600 to-green-600 border-blue-400 text-white shadow-lg shadow-blue-500/20'
                                    : plan.id === 'BUSINESS'
                                        ? 'bg-gradient-to-br from-emerald-600 to-teal-600 border-emerald-400 text-white shadow-lg shadow-emerald-500/20'
                            ...
                            <div className="p-5 sm:p-6 md:p-8 flex flex-col gap-5 lg:w-60 xl:w-68">
                                ...
                                <div className="mt-auto space-y-2">
                                    <button
                                        ...
                                        className="w-full py-3 text-xs font-sans uppercase tracking-widest font-bold transition-all bg-gradient-to-r from-emerald-600 to-teal-600 text-white hover:opacity-90 active:scale-[0.98] flex items-center justify-center gap-2"
                                    >
