...
/**
 * Password input with a show/hide toggle. Drop-in replacement for a raw
 * <input type="password">; forwards all standard input props. The toggle
 * button sits inside the field and flips the type between password/text.
 */
  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        tabIndex={-1}
        className="absolute inset-y-0 right-0 flex items-center pr-3 text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 transition-colors focus-visible:outline-none focus-visible:text-blue-600"
      >
