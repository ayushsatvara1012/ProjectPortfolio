        ...
        <div className="flex flex-col gap-4 w-full min-w-0">
            ...
            {!canLeadCapture ? (
                <div className="bg-white dark:bg-slate-900 rounded-md p-4 sm:p-5 border border-slate-200 dark:border-slate-800">
                    <p className="text-[10px] uppercase tracking-widest font-mono text-slate-400 mb-2">Lead Capture & CRM</p>
                    ...
                    <div className="flex sm:hidden flex-col gap-4 w-full">
                        ...
                        <div className="flex items-center border-b border-slate-200 dark:border-slate-800">
                            <button
                                ...
                                className={`py-2 px-1 mr-5 text-[11px] font-mono uppercase tracking-wider border-b-2 transition-all ${
                                    mobileTab === 'action'
                            ...
                            <button
                                ...
                                className={`py-2 px-1 text-[11px] font-mono uppercase tracking-wider border-b-2 transition-all ${
                                    mobileTab === 'leads'
                                        ? 'border-slate-900 dark:border-slate-100 text-slate-900 dark:text-slate-100 font-semibold'
                                        : 'border-transparent text-slate-400 dark:text-slate-500 hover:text-slate-700 dark:hover:text-slate-300'
                                }`}
