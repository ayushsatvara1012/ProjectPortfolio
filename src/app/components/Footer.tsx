        ...
        <div className="grid grid-cols-1 min-[1011px]:grid-cols-12 gap-px bg-gray-200 dark:bg-slate-800 border-x border-gray-200 dark:border-slate-800">
          ...
          <div className="min-[1011px]:col-span-5 bg-white dark:bg-slate-950 p-12 min-[1011px]:p-16 flex flex-col justify-between gap-12 group/brand relative overflow-hidden transition-colors">
            ...
            <div className="space-y-8 relative z-10">
              <div className="flex items-center gap-3">
                <span className="text-xl min-[1011px]:text-2xl font-google font-bold text-slate-900 dark:text-slate-200 uppercase">
                  SaPy<span className="text-blue-600">Base</span>
                </span>
                <div className="h-px w-8 bg-gray-100 dark:bg-slate-800" />
                <span className="text-sm uppercase tracking-widest font-bold text-slate-600 dark:text-slate-400 font-google">Protocol_V4.2</span>
              </div>
              <h2 className="text-4xl min-[1011px]:text-5xl font-google font-bold tracking-tight text-slate-900 dark:text-slate-200 uppercase">
            ...
            <div className="flex flex-wrap gap-4 relative z-10">
              <button
                ...
                className="bg-slate-900 dark:bg-blue-600 text-white px-8 py-4 rounded-none text-sm uppercase tracking-widest font-bold font-google hover:bg-blue-600 dark:hover:bg-blue-500 transition-all active:scale-95 flex items-center gap-3 group/btn"
              >
          ...
          <div className="min-[1011px]:col-span-7 grid grid-cols-1 sm:grid-cols-3 gap-px bg-gray-200 dark:bg-slate-800">
            ...
            <div className="bg-white dark:bg-slate-950 p-10 min-[1011px]:p-12 space-y-10 group/cell transition-colors duration-500 hover:bg-slate-50/50 dark:hover:bg-slate-900/50">
              <div className="flex items-center gap-2 text-sm uppercase tracking-widest font-bold text-slate-600 dark:text-slate-400 font-google">
                ...
                {navLinks.map((link, idx) => (
                  <li key={idx}>
                    <a
                      ...
                      className="text-slate-500 dark:text-slate-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-all text-sm uppercase tracking-widest font-bold font-google flex items-center justify-between group/link"
                    >
                      {link.name}
            ...
            <div className="bg-white dark:bg-slate-950 p-10 min-[1011px]:p-12 space-y-10 group/cell transition-colors duration-500 hover:bg-slate-50/50 dark:hover:bg-slate-900/50">
              ...
              <ul className="space-y-4">
                {stackList.map((name, idx) => (
                  <li key={idx} className="text-slate-600 dark:text-slate-400 text-sm uppercase tracking-widest font-bold font-google cursor-default hover:text-slate-900 dark:hover:text-slate-200 transition-colors">
                    {name}
                  </li>
                ))}
              </ul>
            ...
            <div className="bg-white dark:bg-slate-950 p-6 min-[1011px]:p-12 space-y-6 min-[1011px]:space-y-10 group/cell transition-colors duration-500 hover:bg-slate-50/50 dark:hover:bg-slate-900/50 relative overflow-hidden">
              <div className="flex items-center gap-2 text-sm uppercase tracking-widest font-bold text-slate-600 dark:text-slate-400 font-google relative z-10">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-px bg-gray-200 dark:bg-slate-800 border border-gray-100 dark:border-slate-800">
                    {[
                      ...
                      >
                        ...
                        <span className="text-sm uppercase tracking-widest font-bold font-google">{social.label}</span>
                      </a>
                    ))}
                  </div>
                </div>
                <div className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <a
                      ...
                      className="text-sm font-google font-medium text-slate-900 dark:text-slate-200 hover:text-indigo-600 dark:hover:text-indigo-400 break-all transition-colors block"
                    >
          ...
          <div className="min-[1011px]:col-span-12 bg-white dark:bg-slate-950 px-6 py-4 min-[1011px]:px-8 min-[1011px]:py-4 border-t border-white dark:border-slate-800 flex flex-col min-[1011px]:flex-row justify-between items-center gap-6">
            <div className="flex flex-col min-[1011px]:flex-row items-center gap-6 text-sm uppercase tracking-widest font-bold text-slate-600 dark:text-slate-400 font-google">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm uppercase tracking-widest font-bold text-slate-900 dark:text-slate-200 font-google">
