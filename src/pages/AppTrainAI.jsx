...
const AppTrainAI = () => {
    ...
    return (
        <div className="flex flex-col h-full bg-[#E8EBF0] overflow-hidden">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-px bg-[#E8EBF0] border-b border-gray-100">
                {ctxLoading
            ...
            {/* ── Main Grid ── */}
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-px bg-[#E8EBF0] flex-1 overflow-hidden">
                {/* Knowledge Sources */}
                <div className={`lg:col-span-7 ${cellCls} p-8 relative overflow-y-auto custom-scrollbar`}>
                    {isFree && (
                        <div className="absolute inset-0 z-20 bg-white/95 flex flex-col items-center justify-center gap-5 p-10">
                ...
                {/* Right column */}
                <div className="lg:col-span-5 gap-px flex flex-col bg-[#E8EBF0] overflow-y-auto custom-scrollbar">
                    {/* Usage */}
