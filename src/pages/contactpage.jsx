          ...
          <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
            ...
            <div className="w-full space-y-6">
              ...
              <div className="grid grid-cols-2 gap-3">
                <a href="mailto:hello@startup.io" className="p-4 rounded-2xl bg-indigo-600/10 border border-dashed border-indigo-600/20 flex flex-col items-center text-center gap-2 hover:scale-[1.02] transition-transform">
                  <Mail size={18} color={'#5039f6'}/>
                  <span className="text-[10px] font-bold uppercase text-indigo-500 tracking-widest">Email Us</span>
                </a>
                <div className="p-4 rounded-2xl bg-emerald-500/10 border border-dashed border-emerald-600/20 flex flex-col items-center text-center gap-2 hover:scale-[1.02] transition-transform text-emerald-500">
