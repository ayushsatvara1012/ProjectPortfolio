        ...
        <div className="flex flex-col h-full bg-[#E8EBF0] overflow-hidden">
            ...
            <div className="bg-white px-8 py-6 shrink-0 border-b border-gray-100">
                <div className="flex items-center gap-2 mb-1">
                    ...
                    <h1 className="text-lg font-bold text-slate-900 tracking-tight uppercase tracking-widest text-base">Bot Identity</h1>
                </div>
                <p className="text-sm text-slate-500">Configure your tenant and get your API integration credentials.</p>
            </div>
            ...
            <SignedOut>
                <div className="bg-white p-8 text-center max-w-md mx-auto border border-gray-100">
                    ...
                    <p className="text-sm text-slate-500 mb-5">Create an account to provision your first AI chatbot.</p>
                    ...
                    {!registrationData ? (
                        ...
                        className="grid grid-cols-1 lg:grid-cols-12 gap-px bg-[#E8EBF0] flex-1 overflow-hidden">
                            ...
                            <div className={`lg:col-span-5 ${cellCls} p-10 overflow-y-auto custom-scrollbar`}>
                                <div className="inline-flex items-center gap-2 px-2 py-1 border border-slate-100 bg-[#FAFAFA] text-[10px] font-bold uppercase tracking-widest text-slate-500 mb-6">
                                    <Sparkles className="w-3 h-3" />
                                    Account provisioned
                                </div>
                                <h2 className="text-3xl font-bold text-slate-900 tracking-tighter mb-4 leading-[1.1]">
                                    Identity &{' '}
                                    <span className="bg-gradient-to-r from-indigo-600 to-indigo-400 bg-clip-text text-transparent">Deployment</span>
                                </h2>
                                <p className="text-sm text-slate-500 mb-8 leading-relaxed font-medium">Provision your tenant, get your API key, and start chatting.</p>
                                <div className="space-y-4">
                                    {[
                                        ...
                                        <div key={i} className="flex items-center gap-4 p-4 border border-gray-100 bg-[#FAFAFA] group hover:border-slate-300 transition-all">
                                            ...
                                            <div>
                                                <p className="text-sm font-bold text-slate-900">{f.text}</p>
                                                <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest mt-0.5">{f.sub}</p>
                                            </div>
                                        </div>
                                    ))}
                                </div>
                            ...
                            <div className={`lg:col-span-7 ${cellCls} p-10 overflow-y-auto custom-scrollbar border-l border-gray-100 relative`}>
                                ...
                                <div className={isLocked ? 'opacity-30 pointer-events-none' : ''}>
                                    ...
                                    {[
                                        ...
                                        <div key={f.name}>
                                            <label className="block text-[11px] font-bold uppercase tracking-widest text-slate-400 mb-1.5">{f.label}</label>
                                            <div className="relative">
                                                ...
                                                <input type={f.type} name={f.name} required value={formData[f.name]}
                                                    onChange={handleChange} className={inputCls} placeholder={f.placeholder} />
                                            </div>
                                        </div>
                                    ))}
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            <label className="block text-[11px] font-bold uppercase tracking-widest text-slate-400 mb-1.5">Theme Color</label>
                                            <div className="relative">
                                        ...
                                        <div>
                                            <label className="block text-[11px] font-bold uppercase tracking-widest text-slate-400 mb-1.5">Tone</label>
                                            <div className="relative">
                                    ...
                                    <button type="submit" disabled={isLoading}
                                        className="w-full flex items-center justify-center gap-2 py-3 min-h-[44px] bg-slate-900 text-white text-xs font-bold uppercase tracking-widest hover:bg-slate-800 transition-colors active:scale-[0.99] disabled:opacity-50">
                                        {isLoading
                        ...
                        <motion.div key="success" initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}
                            ...
                            <div className="bg-white px-8 py-6 flex items-center gap-6 border-b border-gray-100 shrink-0">
                                ...
                                <div>
                                    <h2 className="text-lg font-bold text-slate-900 tracking-tight uppercase tracking-widest">{registrationData.companyName}</h2>
                                    <p className="text-sm text-slate-500 font-medium">Provision successful. Credentials active.</p>
                                </div>
                                <div className="ml-auto flex gap-4">
                                    <button onClick={() => navigate('/app/train')}
                                        className="px-6 py-2.5 bg-slate-900 text-white text-[11px] font-bold uppercase tracking-widest hover:bg-slate-800 transition-all flex items-center gap-2 active:scale-95 shadow-lg">
                                        Train AI <ArrowRight className="w-4 h-4" />
                                    </button>
                                    <button onClick={handleReset}
                                        className="px-6 py-2.5 border border-gray-100 text-slate-900 text-[11px] font-bold uppercase tracking-widest hover:bg-[#FAFAFA] transition-all active:scale-95">
                                        New Tenant
                                    </button>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-[#E8EBF0] border-b border-gray-100">
                                <div className="bg-white p-8">
                                    <div className="flex items-center gap-2 mb-4">
                                        ...
                                        <p className="text-[10px] font-bold uppercase tracking-widest text-slate-400">Secure API Key</p>
                                    </div>
                                    <div className="flex items-center gap-3 p-4 bg-[#FAFAFA] border border-gray-100 font-mono text-sm text-slate-900">
                                ...
                                <div className="bg-white p-8">
                                    <div className="flex items-center gap-2 mb-4">
                                        ...
                                        <p className="text-[10px] font-bold uppercase tracking-widest text-slate-400">Quick Embed</p>
                                    </div>
                                    <div className="relative">
                                        <pre className="p-4 bg-slate-900 text-indigo-300 border border-slate-900 text-[11px] font-mono overflow-x-auto leading-relaxed h-[88px] flex items-center">
                            ...
                            <div className={`${cardCls} p-0! overflow-hidden`}>
                                <div className="p-4 border-b border-slate-100 flex items-center gap-2">
                                    ...
                                    <h3 className="text-[10px] font-bold uppercase tracking-widest text-slate-500">Integration Guides</h3>
                                </div>
                                {integrationGuides.map((guide, i) => (
                                    <div key={i} className="border-b last:border-0 border-slate-100">
                                        ...
                                        >
                                            <span className="text-xs font-bold text-slate-700 font-mono">{guide.title}</span>
                                            <ChevronDown className={`w-3.5 h-3.5 text-slate-400 transition-transform ${openAccordion === i ? 'rotate-180' : ''}`} />
                                        </button>
                                        <AnimatePresence>
                                            {openAccordion === i && (
                                                <motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: 'auto', opacity: 1 }} exit={{ height: 0, opacity: 0 }} className="overflow-hidden">
                                                    <div className="px-5 pb-4">
                                                        <pre className="p-3 bg-slate-50 border border-slate-200 rounded-lg text-[10px] font-mono text-indigo-600 overflow-x-auto leading-relaxed">
