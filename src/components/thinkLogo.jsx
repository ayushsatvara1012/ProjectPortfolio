...
const ThinkingLogo = ({
  ...
  const logoW = size * 0.94;          
  const logoH = logoW / 2;            
  const gap = size * 0.10;          
  const fontSize = size * 0.14;          
  const dotSize = size * 0.045;         
  const dotGap = size * 0.038;         

  const particles = [
    { s: size * 0.031, c: themeColor, t: "8%", l: "44%", a: "tl-fUp", d: "2.8s", dl: "0.0s" },
    { s: size * 0.019, c: "#0F2060", t: "16%", l: "66%", a: "tl-fDR", d: "3.1s", dl: "0.4s" },
    { s: size * 0.025, c: themeColor, t: "40%", l: "88%", a: "tl-fRight", d: "2.6s", dl: "0.8s" },
    { s: size * 0.019, c: "#0F2060", t: "10%", l: "22%", a: "tl-fDL", d: "2.9s", dl: "0.2s" },
    { s: size * 0.025, c: themeColor, t: "40%", l: "4%", a: "tl-fLeft", d: "3.2s", dl: "0.6s" },
    { s: size * 0.019, c: "#0F2060", t: "80%", l: "44%", a: "tl-fDown", d: "3.0s", dl: "1.5s" },
    { s: size * 0.025, c: themeColor, t: "78%", l: "22%", a: "tl-fDown", d: "2.5s", dl: "0.9s" },
  ...
  return (
    ...
    >
      <style>{`
        ...
        .tl-ring-1 { width: 72%;  height: 72%;  border: 1.5px solid ${themeColor}4D; animation: tl-spinCW  4s   linear infinite; }
        .tl-ring-2 { width: 88%;  height: 88%;  border: 1.5px dashed ${themeColor}29; animation: tl-spinCCW 6.5s linear infinite; }
        ...
        .tl-dot-orbit .tl-d:nth-child(1) { background: ${themeColor}; top: -3px; left: calc(50% - 3px); }
        ...
        .tl-tri-orbit::before {
          ...
          border-bottom: 8px solid ${themeColor}8C;
        }
        ...
        .tl-halo {
          ...
          width: 55%; height: 30%;
          border-radius: 50%;
          background: radial-gradient(ellipse, ${themeColor}47 0%, transparent 70%);
      ...
      >
        ...
        >
          {/* Using same logo geometry but optimized for Thinking status */}
          <path opacity=".45" d="M128 104H124C122.895 104 122 104.895 122 106V110C122 111.105 122.895 112 124 112H128C129.105 112 130 111.105 130 110V106C130 104.895 129.105 104 128 104Z" fill={themeColor} />
          <path opacity=".45" d="M276 104H272C270.895 104 270 104.895 270 106V110C270 111.105 270.895 112 272 112H276C277.105 112 278 111.105 278 110V106C278 104.895 277.105 104 276 104Z" fill={themeColor} />
          ...
          <path opacity=".45" d="M201 44H198C196.895 44 196 44.8954 196 46V49C196 50.1046 196.895 51 198 51H201C202.105 51 203 50.1046 203 49V46C203 44.8954 202.105 44 201 44Z" fill={themeColor} />
          ...
          {/* Left iris — scan only */}
          <path className="tl-eye-l" d="M168 101H162C160.343 101 159 102.343 159 104V112C159 113.657 160.343 115 162 115H168C169.657 115 171 113.657 171 112V104C171 102.343 169.657 101 168 101Z" fill={themeColor} />
          {/* Right eye socket */}
          ...
          <path className="tl-eye-r" d="M234 102H228C226.343 102 225 103.343 225 105V113C225 114.657 226.343 116 228 116H234C235.657 116 237 114.657 237 113V105C237 103.343 235.657 102 234 102Z" fill={themeColor} />
