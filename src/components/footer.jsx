    ...
    <footer className="relative bg-white dark:bg-slate-950 pt-24 pb-12 overflow-hidden border-t border-slate-200 dark:border-slate-900 transition-colors">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-10">
          ...
          <div className="lg:col-span-5 p-8 rounded-3xl bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 backdrop-blur-sm flex flex-col justify-between group hover:border-indigo-500/50 transition-all duration-500">
            <div>
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              ...
              <a href="mailto:ayushsatvara2002@gmail.com" className="w-12 h-12 rounded-full border border-slate-200 dark:border-slate-700 text-slate-600 dark:text-white hover:bg-slate-50 dark:hover:bg-slate-800 transition-all flex items-center justify-center">
                <Mail size={20} />
              </a>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 grid grid-cols-2 md:grid-cols-3 gap-8 p-4">
            <div className="space-y-6">
              ...
              <ul className="space-y-4">
                {['Home', 'Projects', 'Services', 'Process'].map((link) => (
                  <li key={link}>
                    <a href={`#${link.toLowerCase()}`} className="text-slate-500 dark:text-slate-400 hover:text-indigo-600 dark:hover:text-white transition-colors text-sm flex items-center gap-1 group py-2">
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-4 text-sm text-slate-500 dark:text-slate-400">
                <li className="hover:text-slate-900 dark:hover:text-white transition-colors cursor-default">React / Vite</li>
                <li className="hover:text-slate-900 dark:hover:text-white transition-colors cursor-default">FastAPI / Python</li>
                <li className="hover:text-slate-900 dark:hover:text-white transition-colors cursor-default">AWS / Cloud</li>
                <li className="hover:text-slate-900 dark:hover:text-white transition-colors cursor-default">PostgreSQL</li>
              </ul>
            </div>
            ...
            <div className="space-y-6 col-span-2 md:col-span-1">
              ...
              <div className="flex gap-4">
                {[
                  ...
                  { Icon: Linkedin, href: "https://www.linkedin.com/in/ayushsatvara" },
                ].map((social, i) => (
                  <a key={i} href={social.href} className="w-12 h-12 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 flex items-center justify-center text-slate-500 dark:text-slate-400 hover:text-indigo-600 dark:hover:text-indigo-400 hover:border-indigo-600/30 dark:hover:border-indigo-400/50 transition-all shadow-sm">
                    <social.Icon size={20} />
                  </a>
                ))}
              </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-slate-100 dark:border-slate-900 text-slate-500 text-xs">
          ...
          <div className="flex gap-6 mt-4 md:mt-0">
            <a href="/privacy-policy" className="hover:text-slate-900 dark:hover:text-white transition-colors py-2 px-1">Privacy</a>
            <a href="/terms-and-conditions" className="hover:text-slate-900 dark:hover:text-white transition-colors py-2 px-1">Terms</a>
