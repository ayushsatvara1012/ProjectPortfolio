...
function projectSection() {
    ...
    return (
      <section id="projects" className="relative py-20 bg-white dark:bg-slate-950 overflow-hidden antialiased">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="grid md:grid-cols-8 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="md:col-span-4 md:col-start-5 lg:col-span-5">
