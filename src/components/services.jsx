      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
          <div className="max-w-2xl">
            <div className="flex items-center gap-3 text-indigo-600 dark:text-indigo-500 font-mono text-xs mb-4 tracking-[0.3em] uppercase">
          ...
          <div className="hidden lg:block text-right">
            <p className="text-slate-400 dark:text-slate-500 font-mono text-xs uppercase tracking-widest leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 auto-rows-fr">
          ...
          <div className="md:col-span-8 group relative rounded-4xl bg-slate-50 dark:bg-slate-900/40 border border-slate-200 dark:border-slate-800 backdrop-blur-xl p-10 overflow-hidden hover:border-indigo-500/50 transition-all duration-700">
            <div className="relative z-20 h-full flex flex-col justify-between">
              ...
              <div className="mt-12 flex items-center gap-6">
                <div className="flex -space-x-3">
                  ...
                  <div className="w-10 h-10 rounded-full bg-indigo-100 dark:bg-indigo-600/20 border border-indigo-200 dark:border-indigo-500/40 flex items-center justify-center backdrop-blur-md">
                    <BrainCircuit size={18} className="text-indigo-600 dark:text-indigo-400" />
                  </div>
                  <div className="w-10 h-10 rounded-full bg-violet-100 dark:bg-violet-600/20 border border-violet-200 dark:border-violet-500/40 flex items-center justify-center backdrop-blur-md">
          ...
          <div className="md:col-span-4 group relative rounded-4xl bg-white dark:bg-slate-900/60 border border-indigo-200 dark:border-indigo-500/30 backdrop-blur-2xl p-8 flex flex-col justify-between overflow-hidden transition-all duration-500 hover:border-indigo-500 hover:shadow-[0_0_40px_-10px_rgba(79,70,229,0.15)] dark:hover:shadow-[0_0_40px_-10px_rgba(79,70,229,0.3)]">

            {/* Inner Glow Aura */}
            <div className="absolute -top-24 -right-24 w-48 h-48 bg-indigo-600/10 dark:bg-indigo-600/20 blur-[80px] rounded-full group-hover:bg-indigo-600/20 dark:group-hover:bg-indigo-600/40 transition-colors duration-700" />

            <div className="relative z-10 space-y-4">
              {/* Animated Icon Container */}
              <div className="w-12 h-12 rounded-xl bg-indigo-50 dark:bg-indigo-500/10 border border-indigo-100 dark:border-indigo-500/20 flex items-center justify-center text-indigo-600 dark:text-indigo-400 group-hover:scale-110 group-hover:bg-indigo-100 dark:group-hover:bg-indigo-500/20 transition-all duration-500">
            ...
            <div className="relative z-10 mt-8">
              <div className="flex flex-wrap gap-2 mb-6">
                <span className="text-[9px] font-mono px-2 py-1 rounded bg-indigo-50 dark:bg-indigo-950/50 border border-indigo-100 dark:border-indigo-800/50 text-indigo-600 dark:text-indigo-300">V8_OPTIMIZED</span>
                <span className="text-[9px] font-mono px-2 py-1 rounded bg-slate-100 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 text-slate-500 dark:text-slate-400">SSR_READY</span>
              </div>

              <div className="pt-4 border-t border-slate-100 dark:border-slate-800 flex justify-between items-center text-[10px] font-mono tracking-widest text-slate-400 dark:text-slate-500">
                <span className="group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors">PERF_INDEX: 100</span>
          ...
          <div className="md:col-span-4 group relative rounded-4xl bg-slate-50 dark:bg-slate-900/40 border border-slate-200 dark:border-slate-800 backdrop-blur-xl p-8 hover:bg-slate-100 dark:hover:bg-slate-900/60 transition-all">
            ...
            <div className="flex gap-2">
              ...
              <div className="h-1 w-4 bg-slate-200 dark:bg-slate-700 rounded-full" />
              <div className="h-1 w-4 bg-slate-200 dark:bg-slate-700 rounded-full" />
            </div>
          </div>

          {/* 04. GLOBAL SCALING - The "Scale" Module */}
          <div className="md:col-span-8 group relative rounded-4xl backdrop-blur-2xl border border-emerald-500/20 dark:border-emerald-500/30 hover:border-emerald-500 hover:shadow-[0_0_40px_-10px_rgba(16,185,129,0.15)] dark:hover:shadow-[0_0_40px_-10px_rgba(16,185,129,0.3)] p-1 flex items-center overflow-hidden duration-300">
            <div className="absolute -top-24 -right-24 w-48 h-48 bg-emerald-600/10 dark:bg-emerald-600/20 blur-[80px] rounded-full group-hover:bg-emerald-600/20 dark:group-hover:bg-emerald-600/40 transition-colors duration-700" />
            <div className="bg-white dark:bg-slate-950 w-full h-full rounded-[1.95rem] p-8 flex flex-col md:flex-row md:items-center justify-between gap-6 transition-all group-hover:bg-slate-50 dark:group-hover:bg-slate-900/30">
              <div className="flex items-center gap-6">
                <div className="p-4 rounded-2xl bg-emerald-50 dark:bg-emerald-500/10 border border-emerald-100 dark:border-emerald-500/20 text-emerald-600 dark:text-emerald-400 group-hover:scale-110 transition-all duration-300">
                  <Globe size={32} />
                </div>
                <div>
