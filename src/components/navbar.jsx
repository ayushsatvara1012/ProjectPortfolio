              ...
              <div key={link.name} className="space-y-2">
                {link.name === "Services" ? (
                  <>
                    ...
                    >
                      {link.name}
                      <ChevronDown size={24} className={`text-indigo-600 transition-transform duration-300 ${isMobileServicesOpen ? 'rotate-180' : ''}`} />
                    </button>

                    {/* Mobile Services Accordion */}
                    <div className={`space-y-4 overflow-hidden transition-all duration-500 ${isMobileServicesOpen ? 'max-h-[500px] mt-4 opacity-100' : 'max-h-0 opacity-0'}`}>
                      {services.map((service, sIndex) => (
                        <a
                          ...
                          className="flex items-center gap-4 p-4 rounded-2xl bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-800 active:scale-[0.98] transition-all"
                        >
                          <div className="p-3 rounded-xl bg-white dark:bg-slate-800 text-indigo-600 dark:text-indigo-400 shadow-sm">
                            {service.icon}
                          </div>
                          <div>
                            <h4 className="text-sm font-bold text-slate-900 dark:text-white">{service.title}</h4>
