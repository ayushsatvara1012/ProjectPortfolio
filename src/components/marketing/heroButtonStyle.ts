...
export const HERO_BUTTON =
  ...
  'dark:bg-white/[0.05] dark:text-slate-100 dark:hover:text-white dark:hover:bg-white/10 ' +
  'backdrop-blur-md border-none transition-all duration-200 cursor-pointer select-none';
