...
export default function ChatbotShowcase() {
  return (
    <section
      id="chatbots"
      className="relative py-16 sm:py-24 overflow-hidden transition-colors duration-500 text-slate-900 dark:text-slate-100"
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6">
        ...
        <p className="mb-10 text-center text-sm sm:text-base font-google font-medium text-slate-600 dark:text-slate-300 tracking-wide">
...
function GenericChatPanel() {
  return (
    <div className="mx-auto w-full max-w-[420px] rounded-[24px] border border-slate-200 bg-white/80 p-5 sm:p-6 shadow-xl backdrop-blur-md dark:border-white/10 dark:bg-white/5">
      <p className="sr-only">
