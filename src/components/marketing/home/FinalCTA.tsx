  ...
  return (
    <section className="bg-[#FAFAFC] dark:bg-[#0B0F19] py-28 lg:py-32 text-center transition-colors duration-500">
      <div className="mx-auto max-w-6xl px-6">
        <div className="mx-auto mb-6 h-[62px] w-[74px] text-[#0F172A] dark:text-[#F8FAFC]" aria-hidden="true">
        ...
        <h2 className="mx-auto max-w-[17ch] font-google text-[32px] font-bold leading-[1.05] tracking-[-0.04em] text-[#0F172A] dark:text-[#F8FAFC] sm:text-5xl lg:text-[54px]">
          Give your website an intelligence that sells.
        </h2>
        <p className="mt-5 font-google text-lg text-[#475569] dark:text-[#94A3B8]">
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3.5">
          ...
          <Link
            href="/contact"
            className="inline-flex items-center rounded-full border border-[#CBD5E1] dark:border-[#1E293B] px-7 py-3.5 font-google text-base font-semibold text-[#0F172A] dark:text-[#F8FAFC] transition-all duration-200 hover:border-[#94A3B8] dark:hover:border-[#475569] hover:-translate-y-0.5"
          >
            Book a demo
          </Link>
        </div>
