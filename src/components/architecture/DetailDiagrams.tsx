...
function DataFlowTextFallback({
  ...
  const labelOf = (id: string) => dataFlow.nodes.find((n) => n.id === id)?.label ?? id;
  return (
    ...
    <div className="mt-10 flex flex-col gap-10">
      ...
      {mermaid ? (
        <section aria-labelledby="arch-behavior-heading">
          ...
          <div className="mt-4 rounded-2xl border border-slate-200 bg-white p-4 dark:border-slate-800 dark:bg-slate-900/60">
            <DiagramErrorBoundary
              fallback={
